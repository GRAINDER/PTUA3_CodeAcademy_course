...
print(my_name.name)
   ...
   # #         self.make_year = make_year#         self.cost = cost#         self.color = color#         self.full_info = f'Full info: {cost} linero - {make_year} years - {color}..'#         self.smth = None#     def get_car_color(self) -> None:#         print(f'My car color: {self.color}')#     def get_cost(self) -> float:#         return self.cost#     def get_full_info(self) -> None:#         print(f'My full info: {self.full_info}')class Car:
